...
/*:
 * @target MZ
 * @plugindesc v1.03 Enables a configurable splash screen which shows images, or plays videos in sequence prior to the title screen. 
 * @author Ramza
 *
 * @param SkipMode
 * @text Skip Mode
 ...
 *
 * Version 1.03:
 * -Corrected an issue where a certain update to the rmmz_scenes corefile would
 *  stop this plugin from working. 
 * Version 1.02:
...
SceneManager.goto = function(sceneClass) {
	if (this._scene && this._scene.constructor.name == "Scene_Boot" && (sceneClass.name == "Scene_Title" || sceneClass.name == "Scene_Splash")) {
